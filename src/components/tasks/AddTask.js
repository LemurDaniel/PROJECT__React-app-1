        ...
        <div className="modal">
            ...
            <div>
                ...
                <header className="p-1 px-2 bg-dark-700  text-xl rounded-t-md   flex justify-start">
                    ...
                    <div className="p-1 mr-3 w-min   hover:bg-white hover:text-dark-700 rounded-full  duration-300" onClick={e => { playSound("button_click"); setDone(!done) }} >
                        {!done ?
                    ...
                    <i className="absolute right-1 top-1 text-sm hover:bg-brand2-250 rounded-full" onClick={e => { playSound("button_click"); showModal(false) }}> <MdCancel /> </i>
                    ...
                    <form >
                        ...
                        <div className="border-b-2 p-2">
                            ...
                            <input type="datetime-local" name="task_date" id="task_date"
                                ...
                                value={date}
                                onChange={e => { playSound("button_click"); setDate(e.target.value); }}
                            />
                        </div>
                        <div className="border-b-2 p-2">
